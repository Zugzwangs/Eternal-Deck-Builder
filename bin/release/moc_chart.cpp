...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Chart_t, stringdata) + ofs \
...
const QMetaObject Chart::staticMetaObject = {
    { &MarbAbstractItemView::staticMetaObject, qt_meta_stringdata_Chart.data,
...
void *Chart::qt_metacast(const char *_clname)
{
    ...
    return MarbAbstractItemView::qt_metacast(_clname);
}

int Chart::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = MarbAbstractItemView::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
